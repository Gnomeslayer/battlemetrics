...
async def note_create(note: str, shared: bool, organization_id: int, player_id: int) -> dict:
    """Create a new note
...
async def leaderboard_info(server_id: int, player: int, start: str, end: str) -> dict:
...
async def activity_logs(blacklist: str = None, whitelist: str = None) -> dict:
